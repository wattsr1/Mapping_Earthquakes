...
// Create the earthquake layer of the map
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  // Create a GeoJSON layer with the data collected.
  L.geoJSON(data, {
    ...
    // location of the earthquake after the marker has been created
    onEachFeature: function(feature, layer) {
      layer.bindPopup("<h3>Magnitude: " + feature.properties.mag + "</h3> <hr></hr> <h3>Location: " + feature.properties.place + "</h3>");
    }
  }).addTo(earthquakes);
