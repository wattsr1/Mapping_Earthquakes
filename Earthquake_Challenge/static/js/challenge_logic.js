...
// 2. Add a reference to the earthquake, tectonic plates, and major earthquake groups to the overlays object.
let overlays = {
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
     ...
     onEachFeature: function(feature, layer) {
      layer.bindPopup("<h2>Magnitude: " + feature.properties.mag + "</h2> <hr></hr> <h2>Location: " + feature.properties.place + "</h2>");
    }
